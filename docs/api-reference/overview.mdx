...
<CardGroup cols={3}>
  <Card title="Droid" icon="robot" href="/api-reference/classes/droid">
    Main entry point for the SDK
  </Card>
  <Card title="Thread" icon="comments" href="/api-reference/classes/thread">
    Multi-turn conversation management
  </Card>
  <Card title="TurnResult" icon="check" href="/api-reference/classes/turn-result">
